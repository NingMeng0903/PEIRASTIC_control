...
namespace log_utils {
inline void
initialize_logger(std::string logger_name = "Controller_logger",
                  std::string console_level = "info", bool use_console = true,
                  std::string log_filename = "logs/Controller_control_program.log",
...
get_logger(std::string logger_name = "Controller_logger") {
